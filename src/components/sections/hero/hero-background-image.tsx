...
const HeroBackgroundImage = () => {
  ...
  const foregroundX = useTransform(mouseX, (x) => x * -0.03);
  const foregroundY = useTransform(mouseY, (y) => y * -0.03);
    ...
    >
      <g id="hero-background-desktop">
        ...
        >
          ...
          <g id="Vector_2" style={{ mixBlendMode: "multiply" }}>
            <path
              d="M1195 -226.404V-592L13 590H378.596L1195 -226.404Z"
          ...
          <g id="Vector_3" style={{ mixBlendMode: "multiply" }}>
            <path
              d="M1011 -629.404V-995L-171 187H194.596L1011 -629.404Z"
      ...
      <defs>
        ...
        >
          ...
          <stop offset="1" stopColor="#0049BF" stopOpacity="0"></stop>
        </linearGradient>
