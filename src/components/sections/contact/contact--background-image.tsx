...
const ContactBackgroundImage = () => {
  ...
  const darkPatternX = useTransform(mouseX, (x) => x * 0.03);
  const darkPatternY = useTransform(mouseY, (y) => y * 0.03);
  const lightPatternX = useTransform(mouseX, (x) => x * -0.03);
  const lightPatternY = useTransform(mouseY, (y) => y * -0.03);
